...
const checks = [
  ...
  { name: "people", path: "/api/people", status: 200, assert: (body) => Array.isArray(body.items) && body.items.length > 0 && body.pagination.total > 0 },
  ...
  { name: "projects", path: "/api/projects", status: 200, assert: (body) => Array.isArray(body.items) && body.items.length > 0 && body.pagination.total > 0 },
